set nocount on
        SELECT 
			[No_], [Status], [Global Dimension 1 Code], [Job Posting Group], [Starting Date], [Ending Date], [Description], [Bill-to Customer No_], [Person Responsible], [Statistics Code 5],
		...
		SELECT 
			...
			,MIN(Arbejdssedler.[Start Date]) AS 'Start'
		...
		GROUP BY 
		Sagsopgaver.[Job No_], Sager.[Ending Date], Sager.[Starting Date]
