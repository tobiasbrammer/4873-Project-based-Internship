set nocount on
	...
	,tt.[Beskrivelse] AS 'mBeskrivelse arbejdstypekode'
 ...
 SELECT DISTINCT
	...
	,ISNULL(#rle_2.earned_time_off_qty,0) 'earned_time_off_qty'
	,ISNULL(#rle_2.over_time_qty,0) 'over_time_qty'
	,ISNULL(#rle_2.allowance_qty,0) 'allowance_qty'
	...
	DROP TABLE #Sager, #Sagsbudget, #AllCombinations, #Arbejdssedler, #Budget, #Budget_final, #budget_v2, #Cal, #MaxArchive, #Regnskab, #Sagsopgaver, #Sagsposter, #RLE, #rle_2
