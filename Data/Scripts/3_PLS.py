...
lSCurve = ['intercept','revenue_scurve_diff', 'costs_scurve_diff', 'contribution_scurve_diff']
...
plt.close('all')
=======
plot_predicted(dfData, 'predicted_fc', 'Forecast Combination', '3_5_fc', transformation='sum', trainMethod=trainMethod, sDepVar=sDepVar)
>>>>>>> Stashed changes
...
dfRMSE = pd.DataFrame({'RMSE': [rmse_dst, rmse_scurve, rmse_ols, rmse_ols_lag, rmse_ols_lag_budget, rmse_fc],
                      ...
                      index=['DST', 'S-curve', 'OLS', 'OLS with lagged variables', 'OLS with lagged variables and budget', 'Forecast Combination'])
>>>>>>> Stashed changes
...
=======
        ...
        if data_subset.shape[0] > 1:
            ...
            dfData.loc[dfData['cluster_' + str(iCluster)] == iClusterLabel, 'predicted_cluster_' + str(
                ...
                dfDataScaled[dfDataScaled['cluster_' + str(iCluster)] == iClusterLabel][lIndepVar_lag_budget]) # 22 cols
            dfData.loc[dfData['cluster_' + str(iCluster)] == iClusterLabel, 'predicted_cluster_' + str(
                iCluster)] = y_scaler.inverse_transform(
                dfData.loc[dfData['cluster_' + str(iCluster)] == iClusterLabel, 'predicted_cluster_' + str(
                    iCluster)].values.reshape(-1, 1))
