...
plt.xlim(dfData['final_estimate_costs'].quantile(0.00000000001), 10)
...
plt.xlim(-10, dfData['final_estimate_revenue'].quantile(0.9999999999))
...
# Plot distribution of budget_revenue, sales_estimate_revenue, production_estimate_revenue and final_estimate_revenue
plt.figure(figsize=(20, 10))
# sns.kdeplot(data=dfData, x='budget_margin', label='budget margin')
